...
public sealed class EriCharacterKitSettings : ScriptableObject
{
    ...
    private static SkillTuning[] Defaults() => new[]
    {
        ...
        new SkillTuning(EriCommandKind.DashSlash, 44, 2, 6, 4f, 0.8f),
        new SkillTuning(EriCommandKind.Shot, 42, 1, 5, 12f, 0.24f),
        new SkillTuning(EriCommandKind.Motivate, 0, 1, 6, 0, 0),
        new SkillTuning(EriCommandKind.Snipe, 72, 3, 10, 16f, 0.24f),
        new SkillTuning(EriCommandKind.Fan, 30, 1, 6, 11f, 0.22f),
        new SkillTuning(EriCommandKind.Grenade, 48, 2, 7, 9f, 2.2f),
        ...
        new SkillTuning(EriCommandKind.Inspire, 0, 2, 10, 0, 0),
        new SkillTuning(EriCommandKind.Silence, 0, 1, 5, 0, 5f),
        new SkillTuning(EriCommandKind.WhipSlash, 30, 1, 3, 4.5f, 0.6f),
        new SkillTuning(EriCommandKind.MarkShot, 0, 1, 4, 13f, 0.3f),
        new SkillTuning(EriCommandKind.Dispel, 0, 1, 4, 9f, 2f),
